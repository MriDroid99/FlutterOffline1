...
class Meals with ChangeNotifier {
  List<Meal> get dummyMeals => [..._dummyMeals];

  List<Meal> get favoriteMeals => [..._favoriteMeals];

  Meal findById(String id) =>
      dummyMeals.firstWhere((element) => element.id == id);

  void addMeal(String id) {
    _favoriteMeals.add(_dummyMeals.firstWhere((element) => element.id == id));
    notifyListeners();
  }
